            ...
            <form action="" autocomplete="off">
                <div class="md:w-2/5 lg:w-1/3 w-2/3">
                    ...
                    <div class="relative mb-7 form-group">
                        ...
                        <input autocomplete="off" type="text" class="form-input px-4 py-3 bg-gray-100 outline-none text-gray-800 w-full transition-all border-b-2 border-gray-300 focus:border-black" fType="inp" required />
                    </div>
                    <div class="relative mb-7 form-group">
                        <label class="top-1/4 left-4 absolute text-gray-500 font-medium pointer-events-none transition-all" fType="lbl">Tên</label>
                        <input type="text" class="form-input px-4 py-3 bg-gray-100 outline-none text-gray-800 w-full transition-all border-b-2 border-gray-300 focus:border-black" fType="inp" required />
                    </div>
                    ...
                    <div class="relative mb-7 form-group">
                        ...
                        <input autocomplete="off" type="email" class="form-input px-4 py-3 bg-gray-100 outline-none text-gray-800 w-full transition-all border-b-2 border-gray-300 focus:border-black" fType="inp" required readonly onfocus="this.removeAttribute('readonly');" />
                    </div>
                    <div class="relative mb-7 form-group">
                        ...
                        <input autocomplete="off" type="password" class="px-4 py-3 bg-gray-100 outline-none text-gray-800 w-full transition-all border-b-2 border-gray-300 focus:border-black" fType="inp" required readonly onfocus="this.removeAttribute('readonly');" />
                    </div>
                    <div class="flex justify-between">
                        <button class="bg-black py-3 px-8 text-white border border-black hover:bg-white hover:text-gray-700 transition-all">Đăng ký</button>
