...
<body>
    ...
    <div class="flex">
        ...
        <div class="flex-1 px-3">
            <header class="my-5">
                <a class="flex text-gray-600 hover:text-gray-800 cursor-pointer items-center group relative" href="../Home">
            ...
            <main class="grid grid-cols-4">
                <div class="col-span-3 px-5">
                    <h3 class="font-semibold text-gray-800">Đang có 1 sản phẩm trong giỏ hàng</h3>
                    <!-- cart item  -->
                    <?php $i = 4;
                    while ($i--) { ?>
                        <div class="grid grid-cols-12 pr-6 mt-1 py-6 border-b border-gray-300" id="cartItem">
                            ...
                            <div class="col-span-5 flex flex-col justify-center pl-3">
                                ...
                                <p class="font-light text-gray-500">Size: S</p>
                            </div>
                            <div class="flex justify-between items-center w-20 col-span-2">
                                <button class="px-1 py-1 bg-gray-100 text-gray-500 hover:text-gray-800 border-2 border-gray-100" id="qty-detail-dec">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12H6" />
                                    </svg>
                                </button>
                                <input type="text" class="w-10 text-center border-t-2 border-b-2 border-gray-100 bg-white" min="1" value="1" id="quantity" name="quantity" disabled />
                                <button class="px-1 py-1 bg-gray-100 text-gray-500 hover:text-gray-800 border-2 border-gray-100" id="qty-detail-inc">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="grid place-items-center col-span-2">
                                <p class="text-gray-700 text-sm">460.000<u>đ</u></p>
                            </div>
                            <div class="grid place-items-center col-span-2">
                                <h3>Thành tiền</h3>
                                <h3 class="text-sm text-red-600 font-medium">340.000 <u>đ</u></h3>
                                <button class="hover:text-red-400" id="deleteItem">
                ...
                <div class="px-2">
                    <div class="border border-gray-300 px-3 bg-gray-50">
                        ...
                        <div class="flex py-4 border-b border-gray-200 justify-between text-gray-800 font-medium">
                            <h3>Tổng tiền</h3>
                            <span>1.300.000 <sup>vnđ</sup></span>
                        </div>
                    ...
                    while ($i--) { ?>
                        <div class="group cursor-pointer">
                            <div class="relative overflow-hidden">
                                <a href="<?= BASE_URL ?>/Collection/Product/<?= 5 ?>">
