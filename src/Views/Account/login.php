...
<body>
    ...
    <div class="flex">
        ...
        <div class="flex-1 px-5">
            <form action="<?= BASE_URL ?>/Account/checklogin" method="post" autocomplete="off">
                <div class="md:w-2/5 lg:w-1/3 w-2/3">
                    ...
                    <div class="relative mb-7 form-group">
                        ...
                        <input name="email" autocomplete="off" type="email" class="form-input px-4 py-3 bg-gray-100 outline-none text-gray-800 w-full transition-all border-b-2 border-gray-300 focus:border-black" fType="inp" required readonly 
onfocus="this.removeAttribute('readonly');"/>
                    ...
                    <div class="relative mb-7 form-group">
                        ...
                        <input name="password" autocomplete="off" type="password" class="px-4 py-3 bg-gray-100 outline-none text-gray-800 w-full transition-all border-b-2 border-gray-300 focus:border-black" fType="inp" required readonly 
onfocus="this.removeAttribute('readonly');"/>
                    </div>
                    <div class="flex justify-between">
                        <button class="bg-black py-3 px-8 text-white border border-black hover:bg-white hover:text-gray-700 transition-all" name="submit">Đăng nhập</button>
    ...
    <script src="<?= BASE_URL ?>/public/scripts/inpanimation.js?v=2"></script>
</body>
