<div class="w-64 bg-gray-700 text-white">
    ...
    <nav class="sticky top-16">
        <a href="<?= BASE_URL ?>/Admin/Dashboard/" class="nav-item transition-all hover:bg-gray-600 hover:text-white text-gray-400 flex px-5 py-3 ">
            ...
            Tổng quan</a>
        <a href="<?= BASE_URL ?>/Admin/Order/" class="nav-item transition-all hover:bg-gray-600 hover:text-white text-gray-400 flex px-5 py-3 ">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="<?= BASE_URL ?>/Admin/Discount/" class="nav-item transition-all hover:bg-gray-600 hover:text-white text-gray-400 flex px-5 py-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
